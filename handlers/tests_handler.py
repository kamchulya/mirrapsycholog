...
TESTS = {
    ...
    "money_avatar": {
        "name": "💰 Финансовый аватар",
        "desc": "Тест на отношения с деньгами через образ купюры",
        "steps": [
            ("money_1", "Возьми в руки самую крупную купюру которая у тебя есть (или представь её).\n\nПосмотри на неё внимательно 2-3 минуты. Рассмотри каждую деталь.\n\nКогда будешь готова — напиши: *что ты чувствуешь держа её в руках?* 👇"),
            ("money_2", "Теперь закрой глаза и представь что эти деньги *превратились в человека*.\n\nКто это? Как он выглядит? Как одет? Как смотрит на тебя? Опиши этого человека 👇"),
            ("money_3", "Этот человек-деньги смотрит на тебя.\n\n*Что ты чувствуешь?* Комфортно? Тревожно? Хочется приблизиться или отойти? Что он говорит или хочет сказать тебе? 👇"),
        ],
        "keys": ["Ощущение от купюры", "Образ человека", "Чувства при встрече"],
...
def tests_menu() -> InlineKeyboardBuilder:
    ...
    builder.row(
        InlineKeyboardButton(text="💰 Финансовый аватар", callback_data="test_money_avatar"),
